...
Function Get-ADReportData {
    ...
    try {
        ...
        # Sicherstellen, dass immer einige Basiseigenschaften geladen werden, falls die Auswahl leer ist oder für die Filterung benötigt wird
        ...
        if ($PropertiesToLoad.Count -eq 0) {
            # Standardeigenschaften, falls nichts ausgewählt wurde (sollte durch UI-Validierung verhindert werden)
        ...
        if ($CustomFilter) {
            ...
            $Filter = "$($FilterAttribute) -like '$($FilterValue)*'"
             ...
             # Wenn nur ein Filterwert ohne Attribut da ist, könnte man z.B. DisplayName als Standard nehmen
             # Oder eine Fehlermeldung ausgeben, dass ein Filterattribut benötigt wird.
             # Fürs Erste filtern wir nach DisplayName, wenn nur ein Wert gegeben ist.
        ...
        if ($Users) {
            # Nur die ausgewählten Attribute für die Ausgabe selektieren
            $Output = $Users | Select-Object ($SelectedAttributes | ForEach-Object { $_.ToString() })
            return $Output
        } else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBF/lbTK4uT55cX
# xTyLusSfZLtQVpWf9V6tKcvcTZ5lH6CCFhcwggMQMIIB+KADAgECAhB3jzsyX9Cg
...
# DQEJBDEiBCBWcZaKmzN0GdT6FVOGk+doY402y6ZVGudnux8G4qW5DzANBgkqhkiG
# 9w0BAQEFAASCAQB8KYAF2t/qz1fkkgxwqx+qdjCLNL15qGphbk/l7jhZoZ2yoJk/
# vaVB5En8pL4txFI084EMuC1Y7XBaf4CAJ8ey/6JW8dNAoJq01pEq8HvsGYLJsgdV
# ZlX1ftJ+cj/zZG54OJSbaAaJpobbfMs0SOSIGmkdbqDFJxvF0Njd5TJNQp/xvxSl
# SUhOa7toKJ7uRMBEoHjmyArQSneEN56D3GvN/uSaoMjCQDOut+hgzar2coWBP3jj
# ETxK9x6p5Or7xThYsQ6WLQPoq2xpecxcNMe8s5T5EaiImBP7b8qR+fQ6RLSicrjm
# 7gRoXSeIGxlHVZ36gykI667qFlsZ6e7JqKKloYIDIDCCAxwGCSqGSIb3DQEJBjGC
# Aw0wggMJAgEBMHcwYzELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJ
# bmMuMTswOQYDVQQDEzJEaWdpQ2VydCBUcnVzdGVkIEc0IFJTQTQwOTYgU0hBMjU2
# IFRpbWVTdGFtcGluZyBDQQIQC65mvFq6f5WHxvnpBOMzBDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MDcwNTE0NDI1N1owLwYJKoZIhvcNAQkEMSIEIOV2xjohvWnAldpqwSU9kIQibVnb
# jOcN7rvYmUL3Zxu/MA0GCSqGSIb3DQEBAQUABIICAEleFl7HpordByzDI5RyHf6D
# mrEjq8CWNt19OFJJa+bdKW9YMoL58wVWQd8KS8Jheq9iZXIsDn+EeKfd8+eMP/Fm
# tRuvVqbsY+ZbRfl70kb8WZ6C+DBkn4311jHxpQ36kSACJlBxUs3+MQI9/YuW3F/v
# x27/VXaUaVkizhWdP5hrBOl8gYthlwg/1YPi3+YPO81q/zHE+9Ln2WbLzxYE4SNe
# ULzd1tbebfZoqlWu1hoFhp4UjZSGfewqRmBdGeixRU+SkLyiJeoZLDY3FcGVtGfB
# ZO20QOO3jfoofWtyZWFX0h6c9zufi0Gej002qXw56uw7YdI0maM/ZQayreAfM69W
# aWDo+rL2L1Rife132Ca/POlHwik4UJJvFePVVtPOsha+CJGXVgiHIeh4+/bZWLIP
# qjPbrrXUwNhPJy57DwbaJytX0mqbaU2jKAyWuWmK+ysvkLnzmf1CEO37Utrh5Zbd
# faSIFFYpW3dyDMgPnJw7PB0gzzQyF89lRfikth76QGs/qKO+yqN+P1IwFQNOwVcL
# SUcnVWjfK51O/Lp/NgCHWFVa3Cn3KechddfDvSJT0Z7AzDOPvBWi+RdNnAPCF9Ou
# Tf9v/cw24ByAazZR9oHuRuV2VfZFwo0yCRrYwDciOrqn47Dr3lODmplpl9P2bff/
# IZNaCpJKwYjDAoEaVzZQ
